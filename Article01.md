...
2018年4月、「[実践WPF業務アプリケーションのアーキテクチャ](https://codezine.jp/article/detail/10727)」としてWPFにおける業務アプリケーションのサンプルアーキテクチャを公開させていただきました。当時の私の持ちうる知識を出し切ったものでしたが、あれから4年。見返してみると大分考えに変化がありました。

大きなポイントとしてドメイン駆動設計（以降DDD）やClean Architectureといったアーキテクチャが日本でも良く語られるようになり、ひろく受け入れられ始めているように見えます。.NET的にはWPFも .NET Frameworkだけでなく .NET上でも動作するようになってきました。
